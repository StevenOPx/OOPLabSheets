...
public class TestArrayList {
    public static void main(String[] args) {
        ...
        Product p7 = new Product(7, "Refill Pad", "This is a refill pad");
        Product p8 = new Product(8, "Eraser", "This is a eraser");
        Product p9 = new Product(9, "Tippex", "This is a tippex");
        ...
        Product p13 = new Product(13, "Red Marker", "This is a red marker");
        Product p14 = new Product(14, "Blue Marker", "This is a blue marker");
        Product p15 = new Product(15, "Calculator", "This is a calculator");
        ...
        do {
            choice = JOptionPane.showInputDialog(null, "1.Add a Product " + "\n2.Amend a Product " +
                    "\n3.Remove a Product" + "\n4.View all Products " + "\n5.Quit " +
    ...
    public static void addProduct(ArrayList<Product> allProducts) {
        ...
        int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Please enter the product id"));
    ...
    public static void amendProduct(ArrayList<Product> allProducts) {
        ...
        String search = JOptionPane.showInputDialog(null, "Please enter the name of the product you wish to amend ");
        ...
        for (Product pr:allProducts)
            ...
            for(Product pr : foundProducts)
                ...
                int searchID = Integer.parseInt(JOptionPane.showInputDialog(null, "The following products matched your search phrase "
                ...
                String amendChoice = JOptionPane.showInputDialog(null, "The details of the product you wish to amend are: "
                        + "\n\n " + productToAmend + "\n\n1.Amend Name " + "\n2.Amend Description " + "3.Cancel Amendment" +
                        "\n\nPlease enter your choice ");
                ...
                {
                    amendChoice=JOptionPane.showInputDialog(null, "The details of the product you wish to amend are: "
                            + "\n\n " + productToAmend + "\n\n1.Amend Name " + "\n2.Amend Description " + "3.Cancel Amendment" +
                ...
                switch(amendChoice) {
                    case "1":
                        String nameNew = JOptionPane.showInputDialog(null, "Please enter the name of the product you wish to amend ");
                        productToAmend.setName(nameNew);
                        break;
                    case "2":
                        String descriptionNew = JOptionPane.showInputDialog(null, "Please enter the new description for the product");
                        productToAmend.setDescription(descriptionNew);
                        break;
    ...
    public static void removeProduct(ArrayList<Product> allProducts) {
        ...
        String text="";
            ...
            int removeChoice = JOptionPane.showConfirmDialog(null, "The details of the product you wish to amend are: "
                    ...
                    "Product Removal Confirmation", JOptionPane.YES_NO_CANCEL_OPTION);

                if(removeChoice == JOptionPane.YES_OPTION)
                {
                    allProducts.remove(productToRemove);

                    JOptionPane.showMessageDialog(null, "Product now removed from the array list!",
    ...
    public static void viewProduct(ArrayList<Product> allProducts) {
        String allProductView="";
        Product pr;
        ...
        while(iterator.hasNext()) {
            ...
            JOptionPane.showMessageDialog(null, allProductView,
